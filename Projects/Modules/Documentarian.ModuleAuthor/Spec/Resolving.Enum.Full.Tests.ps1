...
Describe 'Inspecting a source code for HelpInfo' -Tag Acceptance {
    Context 'when the source code defines an enum' {
        Context 'with a mix of parsed and unparsed decorating comments' {
            BeforeAll {
                $EnumName = 'HelpInfoTestEnumFull'
                $EnumFile = Resolve-Path -Path "$PSScriptRoot/Fixtures/Enums/Full.psm1" |
            ...
            it 'has a synopsis' {
                $HelpInfo.Synopsis | Should -Be 'The synopsis for the enum.'
            }
            ...
            context 'examples' {
                ...
                context 'example 2' {
                    ...
                    it 'has a title' {
                        $Example.Title | Should -Be 'Another'
                    }
            ...
            it 'has notes' {
                $HelpInfo.Notes | Should -Not -BeNullOrEmpty
            }
            ...
            context 'values' {
                ...
                context 'First' {
                    ...
                    it "has a description from the enum's parsed block comment" {
                        $Expected = "The First value's description from the enum block."
                        $First.Description | Should -Be $Expected
                    }
                ...
                context 'Second' {
                    ...
                    it 'has a description' {
                        $Expected = "The Second value's description from the enum block."
                        $Second.Description | Should -Be $Expected
                    }
