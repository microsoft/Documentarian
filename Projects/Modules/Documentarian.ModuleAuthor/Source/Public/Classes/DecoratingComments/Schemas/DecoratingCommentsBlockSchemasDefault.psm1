...
class DecoratingCommentsBlockSchemasDefault : DecoratingCommentsBlockSchema {
    <#
        .SYNOPSIS
        Represents the schema for a comment decorating PowerShell code.

        .DESCRIPTION
        This class represents the schema for a block comment that decorates
        a snippet of PowerShell code. It's only used when a more specific
        schema can't be determined.
