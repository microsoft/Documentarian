...
- [`Add-FrontMatterYamlKey`](Functions/Add-FrontMatterYamlKey.ps1): Adds a hashtable of key-value
  pairs to a **MarkdownBuilder** as YAML. If needed, it recurses to handle complex values.
